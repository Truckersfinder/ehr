...
import {
  LayoutDashboard, FlaskConical, Upload,
  Pill, Receipt, Shield, Heart, LogOut,
} from "lucide-react";
...
const navItems = [
  { title: "Dashboard", url: "/", icon: LayoutDashboard, roles: ["super_admin", "facility_admin", "lab_tech", "pharmacist", "finance"] },
  { title: "Laboratory", url: "/laboratory", icon: FlaskConical, roles: ["super_admin", "facility_admin", "clinician", "nurse", "lab_tech"] },
  { title: "Upload Results", url: "/upload-results", icon: Upload, roles: ["super_admin", "facility_admin", "clinician", "nurse", "lab_tech"] },
